...
var composeState = {
  ...
  views: {
    ...
    "!$default.$default": _Compose2.default
  }
};
...
var mymessagesState = {
  ...
  resolve: {
    ...
    folders: function folders() {
      return _dataSources.FoldersStorage.all();
    }
  },
  ...
  component: _MyMessages2.default,
...
var messageState = {
  ...
  resolve: {
    ...
    message: function message($transition$) {
      return _dataSources.MessagesStorage.get($transition$.params().messageId);
    },
    // Provide the component with a function it can query that returns the closest message id
    nextMessageGetter: function nextMessageGetter(messages) {
      return _messageListUIService2.default.proximalMessageId.bind(_messageListUIService2.default, messages);
    }
  },
  views: {
    ...
    "^.^.messagecontent": _Message2.default
  }
};
...
var messageListState = {
  ...
  { token: 'folder', deps: ['$transition$'], resolveFn: function resolveFn($transition$) {
      return _dataSources.FoldersStorage.get($transition$.params().folderId);
    } },
  ...
  { token: 'messages', deps: ['folder'], resolveFn: function resolveFn(folder) {
      return _dataSources.MessagesStorage.byFolder(folder);
    } }],
  views: {
...
var states = exports.states = [composeState, messageState, messageListState, mymessagesState];
...
exports.MessagesStorage = exports.FoldersStorage = exports.ContactsStorage = undefined;
...
var Contacts = function (_SessionStorage) {
  ...
  function Contacts() {
    ...
    return _possibleConstructorReturn(this, (Contacts.__proto__ || Object.getPrototypeOf(Contacts)).call(this, "contacts", "static/data/contacts.json"));
  }
...
var Folders = function (_SessionStorage2) {
  ...
  function Folders() {
    ...
    return _possibleConstructorReturn(this, (Folders.__proto__ || Object.getPrototypeOf(Folders)).call(this, 'folders', 'static/data/folders.json'));
  }
...
var Messages = function (_SessionStorage3) {
  ...
  function Messages() {
    ...
    return _possibleConstructorReturn(this, (Messages.__proto__ || Object.getPrototypeOf(Messages)).call(this, 'messages', 'static/data/messages.json'));
  }
  ...
  _createClass(Messages, [{
    ...
    value: function byFolder(folder) {
      ...
      searchObject[toFromAttr] = _appConfig2.default.emailAddress;
...
var ContactsStorage = new Contacts();
var FoldersStorage = new Folders();
var MessagesStorage = new Messages();

exports.ContactsStorage = ContactsStorage;
exports.FoldersStorage = FoldersStorage;
...
*/
exports.SessionStorage = function SessionStorage(sessionStorageKey, sourceUrl) {
  var _this = this;
  ...
  this._data = (data ? Promise.resolve(data) : fetch(sourceUrl).then(function (resp) {
    return resp.json();
  })).then(this._commit).then(function () {
...
var _initialiseProps = function _initialiseProps() {
  ...
  this._commit = function (data) {
    sessionStorage.setItem(_this2.sessionStorageKey, JSON.stringify(data));
    return Promise.resolve(data);
  };

  this.all = function (thenFn) {
    var promise = new Promise(function (resolve, reject) {
      setTimeout(function () {
        return resolve(_this2._data);
      }, _appConfig2.default.restDelay);
    });
    return promise.then(thenFn);
  };

  this.search = function (exampleItem) {
    ...
    return _this2.all(function (items) {
  ...
  this.get = function (id) {
    return _this2.all(function (items) {
      return items.find(function (item) {
        return item[_this2._idProp] === id;
      });
    });
  };

  this.save = function (item) {
    return item[_this2._idProp] ? _this2.put(item) : _this2.post(item);
  };

  this.post = function (item) {
    item[_this2._idProp] = (0, _util.guid)();
    return _this2.all(function (items) {
      return (0, _util.pushToArr)(items, item);
    }).then(_this2._commit.bind(_this2));
  };

  this.put = function (item) {
    var eqFn = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _this2._eqFn;

    return _this2.all(function (items) {
      var idx = items.findIndex(eqFn.bind(null, item));
      if (idx === -1) throw Error(item + " not found in " + _this2);
      items[idx] = item;
      return _this2._commit(items).then(function () {
        return item;
      });
    });
  };
...
var MessageListUI = function () {
  ...
  _createClass(MessageListUI, [{
    ...
    value: function proximalMessageId(messages, messageId) {
      var sorted = messages.sort(orderBy(_appConfig2.default.sort));
...
var instance = new MessageListUI();
...
var Compose = function (_Component) {
  ...
  */
  function Compose(props) {
    ...
    var _this = _possibleConstructorReturn(this, (Compose.__proto__ || Object.getPrototypeOf(Compose)).call(this, props));

    _this.uiCanExit = function () {
      if (_this.canExit || (0, _lodash.isEqual)(_this.pristineMessage, _this.state.message)) return true;

      var message = 'You have not saved this message.';
      var question = 'Navigate away and lose changes?';
      return _dialogService2.default.confirm(message, question, "Yes", "No");
    };

    _this.gotoPreviousState = function () {
    ...
    _this.send = function () {
      ...
      _dataSources.MessagesStorage.save(_extends({}, message, { date: new Date(), read: true, folder: 'sent' })).then(function () {
    ...
    _this.save = function () {
      var message = _this.state.message;
      _dataSources.MessagesStorage.save(_extends({}, message, { date: new Date(), read: true, folder: 'drafts' })).then(function () {
        return _this.canExit = true;
      }).then(function () {
        return _this.gotoPreviousState();
      });
    ...
    _this.handleChangeMessage = function (detail) {
      return function (e) {
        return _this.setState({ message: _extends({}, _this.state.message, _defineProperty({}, detail, e.target.value)) });
      };
    };
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            ' ',
            _react2.default.createElement('input', { type: 'text', id: 'to', name: 'to', value: message.to, onChange: this.handleChangeMessage('to') }),
            ' '
          ),
          _react2.default.createElement(
            'div',
            ...
            ' ',
            _react2.default.createElement('input', { type: 'text', id: 'subject', name: 'subject', value: message.subject, onChange: this.handleChangeMessage('subject') }),
            ' '
          )
        ),
        _react2.default.createElement(
          'div',
          { className: 'body' },
          _react2.default.createElement('textarea', { name: 'body', id: 'body', value: message.body, cols: '30', rows: '20', onChange: this.handleChangeMessage('body') }),
          _react2.default.createElement(
            'div',
            { className: 'buttons' },
            _react2.default.createElement(
              'button',
              { className: 'btn btn-primary', onClick: this.gotoPreviousState },
 ...
 */
var MyMessages = function (_Component) {
  _inherits(MyMessages, _Component);

  function MyMessages() {
    _classCallCheck(this, MyMessages);

    return _possibleConstructorReturn(this, (MyMessages.__proto__ || Object.getPrototypeOf(MyMessages)).apply(this, arguments));
  }
    ...
    value: function render() {
      var folders = this.props.folders.map(function (folder) {
        return (
          ...
          _react2.default.createElement(
            _react3.UISrefActive,
            { key: folder._id, 'class': 'selected' },
            _react2.default.createElement(
              'li',
              { className: 'folder' },
              _react2.default.createElement(
                _react3.UISref,
                { to: '.messagelist', params: { folderId: folder._id } },
                _react2.default.createElement(
                  'a',
                  null,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'ul',
              { className: 'selectlist list-unstyled' },
              folders
            )
          ),
          _react2.default.createElement(_react3.UIView, { name: 'messagelist', className: 'messagelist' })
        ),
        _react2.default.createElement(_react3.UIView, { name: 'messagecontent' })
      );
    }
  }]);
...
var makeResponseMsg = function makeResponseMsg(prefix, msg) {
  return { from: msg.to, to: msg.from, subject: prefixSubject(prefix, msg), body: quoteMessage(msg) };
};
...
var Message = function (_Component) {
  ...
  function Message(props) {
    ...
    _this.forward = function () {
      ...
      delete fwdMsg.to;
      _this.stateService.go('mymessages.compose', { message: fwdMsg });
    };
    ...
    _this.remove = function () {
      ...
      _dialogService2.default.confirm("Delete?", undefined).then(function () {
        return _dataSources.MessagesStorage.remove(message);
      }).then(function () {
        return _this.stateService.go(nextState, params, { reload: 'mymessages.messagelist' });
      });
    };
    ...
    */
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              null,
              this.actions.edit ? _react2.default.createElement(
                'button',
                { className: 'btn btn-primary', onClick: this.editDraft },
              ...
              this.actions.reply ? _react2.default.createElement(
                'button',
                { className: 'btn btn-primary', onClick: this.reply },
              ...
              this.actions.forward ? _react2.default.createElement(
                'button',
                { className: 'btn btn-primary', onClick: this.forward },
              ...
              this.actions.delete ? _react2.default.createElement(
                'button',
                { className: 'btn btn-primary', onClick: this.remove },
        ...
        _react2.default.createElement('div', { className: 'body', dangerouslySetInnerHTML: messageBody(message.body) })
      );
    }
  }]);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'messages' },
          _react2.default.createElement(_MessageTable2.default, { columns: folder.columns, messages: messages })
        )
      );
    }
  }]);
...
*/
var tableColumns = [{ label: '', name: 'read' }, { label: 'Sender', name: 'from' }, { label: 'Recipient', name: 'to' }, { label: 'Subject', name: 'subject' }, { label: 'Date', name: 'date' }];
...
var MessageTable = function (_Component) {
  ...
  function MessageTable(props) {
    ...
    var _this = _possibleConstructorReturn(this, (MessageTable.__proto__ || Object.getPrototypeOf(MessageTable)).call(this, props));

    _this.colVisible = function (name) {
      return _this.props.columns.indexOf(name) !== -1;
    };

    _this.changeSort = function (sort) {
      return _this.setState({ sort: sort });
    };

    _this.formattedContent = function (message, col) {
      if (col === 'date') return new Date(message[col]).toISOString().slice(0, 10);
      if (col === 'read') return !message[col] ? _react2.default.createElement('i', { className: 'fa fa-circle', style: { fontSize: '50%' } }) : '';
      return message[col];
    };

    _this.state = { sort: _appConfig2.default.sort };
    return _this;
  }
  ...
  _createClass(MessageTable, [{
    ...
    value: function render() {
      ...
      var visibleColumns = tableColumns.filter(function (column) {
        return _this2.colVisible(column.name);
      });
      var tableHead = visibleColumns.map(function (column) {
        return _react2.default.createElement(
          'td',
          { key: column.name },
          _react2.default.createElement(_SortMessages2.default, { label: column.label, col: column.name, sort: sort, onChangeSort: _this2.changeSort })
        );
      });
      var tableBody = messages.sort((0, _messageListUIService.orderBy)(sort)).map(function (message) {
        return _react2.default.createElement(
          _react3.UISrefActive,
          { key: message._id, 'class': 'active' },
          _react2.default.createElement(
            _react3.UISref,
            { to: '.message', params: { messageId: message._id } },
            _react2.default.createElement(
              'tr',
              null,
              visibleColumns.map(function (column) {
                return _react2.default.createElement(
                  'td',
                  { key: column.name },
                  _this2.formattedContent(message, column.name)
                );
              })
            )
          )
 ...
 */
var SortMessages = function (_Component) {
  _inherits(SortMessages, _Component);
  ...
  function SortMessages() {
    ...
    _classCallCheck(this, SortMessages);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SortMessages.__proto__ || Object.getPrototypeOf(SortMessages)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function (e) {
      var _this$props = _this.props,
          col = _this$props.col,
          sort = _this$props.sort,
          onChangeSort = _this$props.onChangeSort;

      var newSort = sort === '+' + col ? '-' + col : '+' + col;
      onChangeSort(newSort);
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(SortMessages, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          col = _props.col,
      ...
      if (sort == '+' + col) sortClass = 'fa-sort-asc';else if (sort == '-' + col) sortClass = 'fa-sort-desc';
      var chevron = _react2.default.createElement('i', { style: { paddingLeft: '0.25em' }, className: 'fa ' + sortClass });
...
SortMessages.propTypes = {
  ...
  onChangeSort: _propTypes2.default.func
};
exports.default = SortMessages;
