...
var contactsState = {
  ...
  resolve: {
    ...
    contacts: function contacts() {
      return _dataSources.ContactsStorage.all();
    }
  },
...
var viewContactState = {
  ...
  resolve: {
    ...
    contact: function contact($transition$) {
      return _dataSources.ContactsStorage.get($transition$.params().contactId);
    }
  },
  component: _ContactView2.default
};
...
var editContactState = {
  ...
  views: {
    ...
    '^.^.$default': {
      ...
      component: _EditContact2.default
    }
  }
};
...
var states = exports.states = [contactsState, viewContactState, editContactState, newContactState];
  ...
  _createClass(Contacts, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'my-contacts flex-h' },
        _react2.default.createElement(_ContactList2.default, { contacts: contacts, className: 'flex nogrow' }),
...
var ContactList = function (_Component) {
  ...
  _createClass(ContactList, [{
    ...
    value: function render() {
      ...
      var newContact = _react2.default.createElement(
        _react3.UISref,
        { to: '.new' },
        _react2.default.createElement(
          'a',
      ...
      var contacts = this.props.contacts.map(function (contact, index) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              _react3.UISref,
              { to: '.contact', params: { contactId: contact._id } },
              _react2.default.createElement(
                'a',
                { href: 'asd' },
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'ul',
          { className: 'selectlist list-unstyled flex nogrow' },
          _react2.default.createElement(
            'li',
            null,
            newContact
...
var ContactView = function (_Component) {
  ...
  _createClass(ContactView, [{
    ...
    value: function render() {
      ...
      var composeButton = _react2.default.createElement(
        _react3.UISref,
        { to: 'mymessages.compose', params: { message: { to: contact.email } } },
        _react2.default.createElement(
          'button',
          { className: 'btn btn-primary' },
      ...
      var editContactButton = _react2.default.createElement(
        _react3.UISref,
        { to: '.edit' },
        _react2.default.createElement(
          'button',
      ...
      return _react2.default.createElement(
        'div',
        { className: 'contact' },
        _react2.default.createElement(_ContactDetail2.default, { contact: contact }),
        composeButton,
        ' ',
        editContactButton
      );
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('img', { src: contact.picture })
        )
      );
    }
  }]);
...
var EditContact = function (_Component) {
  ...
  function EditContact(props) {
    ...
    _this.uiCanExit = function (trans) {
      ...
      return _dialogService2.default.confirm(message, question);
    };

    _this.handleChangeContact = function (contact) {
      _this.setState({ contact: contact });
    };

    _this.save = function () {
      // Save the contact, then go to the parent state (either 'contacts' or 'contacts.contact')
      var stateService = _this.props.transition.router.stateService;

      _dataSources.ContactsStorage.save(_this.state.contact).then(function () {
        return _this.canExit = true;
      }).then(function () {
        return stateService.go('^', null, { reload: true });
      });
    };
    ...
    _this.remove = function () {
      ...
      _dialogService2.default.confirm('Delete contact: ' + contact.name.first + ' ' + contact.name.last).then(function () {
        return _dataSources.ContactsStorage.remove(contact);
      }).then(function () {
        return _this.canExit = true;
      }).then(function () {
        return stateService.go("^.^", null, { reload: true });
  ...
  _createClass(EditContact, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'contact' },
        _react2.default.createElement(_ContactForm2.default, { contact: contact, onContactChange: this.handleChangeContact }),
...
var formInputs = [{ label: 'First', path: 'name.first' }, { label: 'Last', path: 'name.last' }, { label: 'Company', path: 'company' }, { label: 'Age', path: 'age' }, { label: 'Phone', path: 'phone' }, { label: 'Email', path: 'email' }, { label: 'Street', path: 'address.street' }, { label: 'City', path: 'address.city' }, { label: 'State', path: 'address.state' }, { label: 'Zip', path: 'address.zip' }, { label: 'Image', path: 'picture' }];
...
var ContactForm = function (_Component) {
  ...
  function ContactForm() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ContactForm.__proto__ || Object.getPrototypeOf(ContactForm)).call.apply(_ref, [this].concat(args))), _this), _this.handleChangeFor = function (path) {
      var _this$props = _this.props,
          contact = _this$props.contact,
          onContactChange = _this$props.onContactChange;

      return function (event) {
        onContactChange((0, _lodash.set)(_extends({}, contact), path, event.target.value));
      };
  ...
  _createClass(ContactForm, [{
    ...
    value: function render() {
      ...
      var inputs = formInputs.map(function (input) {
        return _react2.default.createElement(
          'div',
          { key: input.path },
          _react2.default.createElement(
          ...
          _react2.default.createElement('input', { type: 'text', value: (0, _lodash.get)(contact, input.path), onChange: _this2.handleChangeFor(input.path) })
        );
      });
      return _react2.default.createElement(
        'div',
...
ContactForm.propTypes = {
  contact: _propTypes2.default.object,
  onContactChange: _propTypes2.default.func
};
